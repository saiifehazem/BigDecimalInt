    ...
    if (nSign == '+' && anotherDec.nSign == '+') {
        ...
        for (int i = 0; i < mx; ++i) {
            if (numA[i] + anotherDec.numA[i] >= 10) {
                ...
                //cout << numA[i] <<  "+" << anotherDec.numA[i] <<'=' << temp[i]<< endl;
                reminder = false;
        ...
        finalNum = result.str();
        if (reminder) finalNum = "1" + finalNum;
    }
        ...
        if (sz1 > sz2) {
            ...
            reverse (anotherDec.numA.begin(),anotherDec.numA.end());
            // 555 - 444
            if ( numA > anotherDec.numA) {
                for (int i = mx-1; i >= 0; --i) {
                    if ( numA[i] - anotherDec.numA[i] < 0 ) {
                        temp[i] = 10 + numA[i] - anotherDec.numA[i];
                        numA[i-1] -=1;
                }
                    else {
                        temp[i] = numA[i] - anotherDec.numA[i];
             ...
             else if (numA < anotherDec.numA) {
                for (int i = mx-1; i >=0 ; --i) {
                    if ( anotherDec.numA[i] - numA[i] < 0 ){
                        temp[i] = 10 + anotherDec.numA[i] - numA[i];
                        anotherDec.numA[i] -=1;
                    }
                    else {
                        temp[i] = anotherDec.numA[i] - numA[i];
             ...
             else if ( numA == anotherDec.numA ) { finalNum = "0";}
